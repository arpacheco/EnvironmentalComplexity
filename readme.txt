...
Both scripts use experimental data from the 'dataExperimental' directory as inputs, as well as simulated data from the 'dataComsumerResource' for epistasis comparisons.
	...
	Simulated data files:
		- dataConsumerResource/epistasisS13_N32_G0_RS50_nSM10_062320.mat
		- dataConsumerResource/epistasisS13_N32_GV_RS50_nSM10_062320.mat

		Both are .mat files containing consumer resource model data generated by the 'solveCRMGeneric.m' script. The first contains data for a consumer resource model in which no organisms are generalists (CRM-A), and the second contains data for a model in which the generalist-specialist balance of organisms are based on the organisms used in the com13 experiment (CRM-B).
...
SYSTEM REQUIREMENTS:
	...
	Tested on: Mac OS X Catalina and Mojave; Windows 10
